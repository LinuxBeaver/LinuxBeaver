...
On september 1st 2025 All my plugins updated so they no longer report potential crash warnings in GIMP 3.14. Though this update does not resolve slow GIMP startup times, when using many GEGL plugins they will still cause GIMP to start up slow. This update pushed by GIMP team is the culprit https://github.com/GNOME/gimp/commit/8e2a0381d7cd73e3c952a796afa79bf5c3fd8125. I am pretty sure they will fix it soon.
